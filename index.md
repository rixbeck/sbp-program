...
1. A FŐVÁROSI ÖNKORMÁNYZÁS SZERVEZETI KÉRDÉSEI 
    1. Agglomerációs önkormányzás
    2. Nyitott döntéselőkészítés
    3. Közösségi önkormányzás
    4. Átlátható önkormányzati pénzügyek
        1. Konkrét intézkedések a közbeszerzések kifehérítésére
        2. A zöld közbeszerzésekkel kapcsolatos első lépések
    5. Fenntartható költségvetési politika
    6. Önkormányzati kiadványok és megjelenés 
    7. Budapest „külügyei”, a Kárpát-medence és Közép-Európa térszerkezete
    8. Innovatív közigazgatás és önkormányzás
    9. Önkormányzati rendvédelem és közbiztonság
    
2. VÁROSSZERKEZET 
    1. Koncepció 
        1. Kompakt város 
        2. Fenntartható város 
    2. A belváros mint az egész városszerkezet magja
        1. A belvárosi mag térszerkezte  
        2. A közösségre gyakorolt hatása  
        3. Az egyenlőtlen fejlődés elkerülése 
    3. Alközpont-hálózat
        1. A köztes zónában levő, illetve külvárosi központok
        2. A központi sétálózóna kifelé nyújtott csápjai
        3. Városrészi, alközponti funkciók 
    4. Kertvárosok, alvóvárosok 
        1. Agglomerációs alközpontok
        2. Szociális szabályzat a kertvárosi övezetekben
    5. Barnazóna, rozsdazóna
        1. A barnazóna zöldenergetikai célú fejlesztése
        
3. VÁROSARCULAT ÉS ÖRÖKSÉGVÉDELEM 
    1. Urbanisztikai alapvetések
        1. A város mint táj
        2. Közösségépítés, identitásképzés
        3. Taktikai városfejlesztés
    2. Városarculat
        1. Mit értünk városarculat alatt? 
        2. A városrészi identitás mint arculat
        3. Sétálóterek
        4. „Tematikus sétálóútvonalak” 
    3. Örökségvédelem 
        1. Fordított védelem
        2. Örökséggazdálkodás 
        3. A történelmi utcakép és egyéb építmények flexibilisebb védelme
    4. Utcakép
        1. Közterület-használat  
        2. Egészséges utca
    5. Lakótelepek
    6. Duna
    7. Álláspontunk további arculatot érintő kérdésekben
    
4. KÖZLEKEDÉS 
    1. A sétálóövezetek
        1. A központi sétálózóna kiterjedése
        2. A központi sétálózóna felépítése
        3. Kerületi sétálózónák 
        4. Időben ütemezhető, ütemezendő?
    2. A fővárosi úthasználati díj, avagy „dugódíj” 
        1. Az úthasználati díjas terület elhelyezkedése
        2. Alaptarifák, díjbeszedés
        3. Mentességek, tiltások, ingyenes útszakaszok
    3. Tömegközlekedés 
        1. A mainál klasszisokkal magasabb minőségi elvárások 
        2. A teljes villamoshálózatot érintő beavatkozások
        3. Az első ciklusban megépítendő infrastruktúrafejlesztések
        4. A második ciklus végéig megépítendő fejlesztések
        5. A középtávon megvalósítandó fejlesztések összefoglalása
        6. További vizsgálandó fejlesztések 
        7. Buszhálózat (és troli)
        8. Éjszakai hálózat 
        9. Tömegközlekedési tarifák 
        10. A közlekedési rendszer szervezete és egyéb üzemeltetési kérdései 
    4. Közút, az autózás jövője
        1. Parkolás és közútfenntartás
        2. Közúthálózat-fejlesztés 
        3. Taxi  
        4. Autómegosztás
        5. A jövő: felkészülés az önvezető autókra
        6. A városi (közúti) áruszállítás jövője: közforgalmú városi logisztika 
    5. Kerékpáros közlekedés
        1. Helyzetkép: gyors fejlődés után a megtorpanás jelei
        2. Lépések a további fejlődés elősegítése érdekében
    6. Duna
